...
import animationData from '../lotties/ani5';
      ...
      <div className="list row">
        ...
        <div className="col-md-8">
          <div className="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Search Region Heads " aria-label="Search User"
        ...
        <div className="col-md-6">
          ...
          <Button
           ...
           href="\addadmin"
           >
          <span style={{color:"white"}}>Add Region Head</span>
        </Button> 
...
{/* 
        ...
        <input type="text" class="form-control" placeholder=
          ...
          aria-describedby="button-addon1"/>
            ...
            type="submit"
            href={"/userlist2/" + currentUser.id}>
          <span ><i class="fas fa-tasks"> </i> City Heads</span>
        </Button>
        <Button
            className="btn btn-sm"
            color="btn btn-elegant accent-3"
