...
export default class TaskAdmin extends Component {
  ...
  updatePublished(status) {
    ...
    TaskDataService2.update(this.state.currentTask.id, data)
      .then(response => {
        this.setState(prevState => ({
          currentTask: {
            ...prevState.currentTask,
  ...
  deleteTask() {    
    TaskDataService2.delete(this.state.currentTask.id)
      .then(response => {
        console.log(response.data);
  ...
  {currentTask ? (
    ...
    <div className=" edit-form">
      ...
      <Button
          ...
          <span style={{color:"white"}}>Update</span>
           ...
           {/* {currentTask.published ? (
                 <Button
                 className="btn btn-sm"
                 color="btn btn-light accent-3"
                 type="submit"
                 onClick={() => this.updatePublished(false)}
                 >
                <span style={{color:"black"}}>Unpublish</span>
     ...
     >
    <span style={{color:"white"}}>Delete</span>  </Button> 
