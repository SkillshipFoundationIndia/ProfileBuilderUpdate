...
import animationData from './lotties/ani4';
   ...
   <ParticleComponent />
    ...
    <div className="">
      ...
      />
          ...
          <Col md={5}>  
             <div className="" style={{borderRadius: 5 ,width: "auto", align:"center"}}>
              ...
              <img src={logo1} class="img-fluid mx-auto d-block" height="150" width="150" alt="Responsive image"/>
                <Form
     ...
     {/* <Row>
              <Col md={3}></Col>
              <Col>
              <a style={{ textAlign: 'right' }}>Campus CEO? <a href="/login">Login</a></a>
              </Col>
